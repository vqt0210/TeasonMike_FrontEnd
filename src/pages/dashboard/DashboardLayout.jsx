...
import { MdDashboard, MdOutlineManageHistory, MdSettings } from "react-icons/md";
          ...
          <div className="flex items-center flex-shrink-0 ml-auto">
            <button className="inline-flex items-center p-2 rounded-lg hover:bg-gray-100 focus:bg-gray-100">
              ...
              <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                <span className="font-semibold">VQT_ZZ</span>
                <span className="text-sm text-gray-600">Smooch</span>
              </div>
              <span className="w-12 h-12 ml-2 mr-2 overflow-hidden bg-gray-100 rounded-full sm:ml-3">
                <img src="https://en.meming.world/images/en/1/18/Giga_Chad.jpg" alt="user profile photo" className="object-cover w-full h-full" />
              </span>
